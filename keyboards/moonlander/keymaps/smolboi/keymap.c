...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SYMB] = LAYOUT_moonlander(
    ...
    _______, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD,                                          KC_UNDS, KC_1   , KC_2   , KC_3   , KC_AMPR, _______, 
  ...
  [SYM2] = LAYOUT_moonlander(
    ...
    _______, KC_TAB , _______, _______, _______, KC_DEL , _______,                        _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, _______, KC_F12,
